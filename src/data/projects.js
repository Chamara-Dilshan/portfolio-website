export const projects = [
  ...
  },
  {
    ...
    description:
      'A modern e-commerce platform with product catalog, shopping cart, user authentication, and payment integration.',
    image: '/projects/e-commerce.png',
    tech: ['React', 'Redux', 'Node.js', 'Stripe'],
    liveUrl: null,
    githubUrl: 'https://github.com/Chamara-Dilshan/e-commerce-store',
    features: [
  ...
  },
  {
    ...
    description:
      'A machine learning model that predicts plant diseases based on leaf images using convolutional neural networks (CNN).',
